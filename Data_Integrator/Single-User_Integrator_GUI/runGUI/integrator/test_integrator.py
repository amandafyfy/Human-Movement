...
def test_base_files_exist():
    assert os.path.isfile("../first*.command") == True
...
def test_output_exist():
    ...
    assert os.path.isfile("../output/*/*/hanFinal*.csv") == True
    assert os.path.isfile("../output/*/*/garmin*.csv") == True
    assert os.path.isfile("../output/*/*/profile*.csv") == True


def test_output_content():
    # test using Real Test Data only
    with open("../output/*/*/hanFinal*.csv") as f:
        txt = f.read().split("\n")
